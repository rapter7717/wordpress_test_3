...
<div class="navigation-bar">
	<header id="masthead" class="site-header container">
		<div class="site-branding">
			...
			$nvc_interactive_description = get_bloginfo( 'description', 'display' );
			if ( $nvc_interactive_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $nvc_interactive_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
